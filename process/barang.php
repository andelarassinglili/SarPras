...
if(isset($_POST['ubah'])){
    ...
    $update = mysqli_query($con,"UPDATE barang SET merek_id='$merek_id', kategori_id='$kategori_id', nama_barang='$nama_barang', stok='$stok', keterangan='$keterangan' WHERE idbarang='$id'") or die (mysqli_error($con));
